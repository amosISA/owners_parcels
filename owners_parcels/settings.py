"""
Django settings for owners_parcels project.
...
SECRET_KEY = 'gs@6t-$g!xt&bf-u63kkh)g1b7x1o^ufc-t5fe^si$qy)p4zm$'
...
ROOT_URLCONF = 'owners_parcels.urls'
...
WSGI_APPLICATION = 'owners_parcels.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "parcels/static"),
]
